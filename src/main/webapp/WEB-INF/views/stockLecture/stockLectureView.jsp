...
$(function(){
    ...
    $('#sl_content').summernote('disable');
    
    $('#lectureDeleteBtn').click(function(){
		var sl_no = "${stockLectureInfo.sl_no}";
		location.href='${pageContext.request.contextPath}/stockLecture/deleteStockLecture.do?sl_no='+ sl_no;
	});
    
    $('#lectureUpdateBtn').click(function(){
    	var sl_no = "${stockLectureInfo.sl_no}";
		location.href='${pageContext.request.contextPath}/stockLecture/stockLectureViewUpdate.do?sl_no='+ sl_no;
	});
    ...
    if('${LOGIN_ADMININFO}'==""){
        ...
        $('#lectureDeleteBtn').hide();
    } else {
        $('#lectureUpdateBtn').show();
        $('#lectureDeleteBtn').show();
    }
            ...
            <content>
                ...
                <form class="articleContent" method="post">
                    ...
                    <div class="title">
                        ...
                        <input type="text" class="box-simple-full" id="sl_title" name="sl_title" value="${stockLectureInfo.sl_title }" disabled="disabled" placeholder="">
                    </div>
                    <div id="sl_content"></div>
                    <div class="form-group">
						<label class="control-label col-sm-2" for="lecture_url">강좌URL:</label>
						<div class="col-sm-10">
							 <input type="text" class="box-simple-full" id="lecture_url" name="lecture_url" value="${stockLectureInfo.lecture_url }" disabled="disabled" data-buttonName="btn-primary">
						</div>
					</div>
                    <div class="submitBtn">
                        <input id="lectureUpdateBtn" class="btn-simple" type="button" value="수정">
                        <input id="lectureDeleteBtn" class="btn-simple" type="button" value="삭제">
