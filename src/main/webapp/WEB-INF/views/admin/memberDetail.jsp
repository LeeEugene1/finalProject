...
$(function(){
	...
	$('#OutPlease').click(function(){
		var mem_id = $('input[name=mem_id1]').val();
		location.href = '${pageContext.request.contextPath}/admin/memberDelete.do?mem_id='+ mem_id;
	});
	...
	<div class="wrap">
        <div class="headerSubandContent">
            ...
            <div class="box-signup">
                <form class="join" action="${pageContext.request.contextPath}/member/updateMemberInfoAdmin.do" method="post">
                    <div class="id">
                    ...
                    <div class="mem_delete_label">
                        <p>탈퇴신청여부</p>
                        <input type="text" id="sample6_postcode" class="box-simple-w100" name="mem_deletecheck" value="${memberInfo.mem_deletecheck }" disabled="disabled">
                    </div>
                    
                    <div class="submitBtn">
                        <input class="btn-simple" type="button" id="OutPlease" value="탈퇴처리">
                        <input class="btn-simple" type="button" id="memUpdate" value="회원수정">
                        <input class="btn-simple" type="button" onclick="javascript:location.href='${pageContext.request.contextPath}/admin/userManagement.do'" value="취소">
                    </div>
                </form>
            </div> 
            </content>
